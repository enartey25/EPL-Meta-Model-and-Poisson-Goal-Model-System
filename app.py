...
.stButton > button:hover { background: #00b890; }
...
.stDataFrame { border: 1px solid #30363d; border-radius: 0; overflow: hidden; }
...
# ═══════════════════════════════════════════════════════════════════════════════
if nav == "Home":
    st.markdown("<div class='hero-title'>EPL <span>Match Predictor</span></div>", unsafe_allow_html=True)
    st.markdown("""
    ...
    <div style='background:#161b22; border-left:3px solid #f59e0b;
                border-radius:0; padding:12px 16px; margin-bottom:24px;
...
# ═══════════════════════════════════════════════════════════════════════════════
    ...
    <div style='background:#161b22; border:1px solid #f43f5e44;
                border-radius:0; padding:12px 16px; margin-bottom:20px;
                font-size:12px; color:#8b949e; line-height:1.7;'>
    ...
    if predict_btn:
        with st.spinner("Running stacked model + calibrated Poisson..."):
            try:
                ...
                st.markdown(f"""
                <div style='background:#161b22; border:1px solid #7c3aed44; border-radius:0;
